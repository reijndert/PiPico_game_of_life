# https://gist.github.com/robert/5100dfffe8afbb04b560dd0fff184753
...
SDA_PIN = 20 
SCL_PIN = 21
I2C_NUM_ROWS =  4  # lines
I2C_NUM_COLS = 20  # columns
...
if __name__ == "__main__":
    #init i2c
    # I2C_ADDR     = 63 # default 63 but will be determined later on
    i2c = I2C(0, sda=machine.Pin(SDA_PIN), scl=machine.Pin(SCL_PIN), freq=400000)
    I2C_ADDR = i2c.scan()[0] #mostly,first in list
    print("I2C devices found on address(es)", I2C_ADDR)
    lcd = I2cLcd(i2c, I2C_ADDR, I2C_NUM_ROWS, I2C_NUM_COLS)    

    lcd.putstr("GAME OF LIFE")
    lcd.putstr("\non")
    lcd.putstr("\nRaspberry PI Pico")
    time.sleep(5)
    
    #start game of life
    init_state = random_state(20, 4)
